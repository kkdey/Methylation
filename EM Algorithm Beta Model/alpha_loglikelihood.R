...
res=optim(alpha_true[,gene_label], function(v) meth_loglik_EM_alpha(v,meth,omega_true,phi_true,gene_label),
		method="Nelder-Mead")

meth_loglik_EM_alpha(alpha_true[,gene_label],meth,omega_true,phi_true,gene_label)

meth_loglik_EM_alpha(alpha0[,g],meth,omega_preprocess,phi_true,g)
